...
import { RoomSchema, FormData } from "@/app/schemas";
...
const RoomModal = ({ onSubmit, equipments }: RoomModalProps) => {
    ...
    return (
        <DialogPrimitive.Root open={open} onOpenChange={setOpen}>
            ...
            <DialogPrimitive.Portal>
                ...
                >
                    <DialogHeader>
                        <DialogPrimitive.Title className="text-xl font-semibold">Dodaj nowy pokój</DialogPrimitive.Title>
                    </DialogHeader>
                    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4 mt-4">
                        ...
                        <div>
                            ...
                            />
                            {errors.capacity && (
                                <p className="text-red-500 text-sm mt-1">{errors.capacity.message?.toString()}</p>
                            )}
                        </div>

                        <div>
                            <Label htmlFor="equipments">Wyposażenie</Label>
                            <Controller
                                control={control}
                                name="equipments"
                                render={({ field }) => (
